...
EXTERNAL_BMP_DATA(Image_3);
EXTERNAL_BMP_DATA(Image_4);
EXTERNAL_BMP_DATA(Image_5);

/* OSEK declarations */
DeclareTask(TASK_e898e3e41c9c4cd28025b833523928b7);
DeclareTask(TASK_cbc7ff945c887eb060734efd34e);
...
/* Tasks */
TASK(TASK_e898e3e41c9c4cd28025b833523928b7)
{
	label_e898e3e41c9c4cd28025b833523928b7:
	while (ecrobot_get_nxtcolorsensor_id(NXT_PORT_S1) != NXT_COLOR_YELLOW) {
		wait(4);
	}
	label_d4a3fffb44c0c98a1c1f8569a2e32:
	
	label_cbc7ff945c887eb060734efd34e:
	while ((bool)(x = 3)) {
		goto label_e3b6c1cef5084da89fa5723754772fda;
	}
	goto label_a5eb58fe09c443a4b34046036b198665;
	label_e3b6c1cef5084da89fa5723754772fda:
	ActivateTask(TASK_e898e3e41c9c4cd28025b833523928b7);
	label_ccaf4c6624cd4f4783f8876877991498:
	while (ecrobot_get_nxtcolorsensor_id(NXT_PORT_S1) != NXT_COLOR_GREEN) {
		wait(4);
	}
	goto label_d4a3fffb44c0c98a1c1f8569a2e32;
	label_a5eb58fe09c443a4b34046036b198665:
	x = ecrobot_get_nxtcolorsensor_id(NXT_PORT_S1);
	label_d63a6972cc544ff4941d0460354709b2:
	ActivateTask(TASK_cbc7ff945c887eb060734efd34e);
	...
	ecrobot_bmp2lcd(BMP_DATA_START(Image_3), lcd, 100, 64);
	for (int _counter = 0; _counter < sizeof(lcd); ++_counter) {
		lcd[_counter] |= lcd_copy[_counter];
	}
	display_bitmap_copy(lcd, 100, 8, 0, 0);
...
TASK(TASK_cbc7ff945c887eb060734efd34e)
{
	label_cbc7ff945c887eb060734efd34e:
	while ((bool)(x = 3)) {
		goto label_e3b6c1cef5084da89fa5723754772fda;
	...
	goto label_cbc7ff945c887eb060734efd34e;
	label_a5eb58fe09c443a4b34046036b198665:
	x = ecrobot_get_nxtcolorsensor_id(NXT_PORT_S1);
	label_d63a6972cc544ff4941d0460354709b2:
	ActivateTask(TASK_cbc7ff945c887eb060734efd34e);
	...
	ecrobot_bmp2lcd(BMP_DATA_START(Image_4), lcd, 100, 64);
	for (int _counter = 0; _counter < sizeof(lcd); ++_counter) {
		lcd[_counter] |= lcd_copy[_counter];
	}
	display_bitmap_copy(lcd, 100, 8, 0, 0);
	...
	ecrobot_bmp2lcd(BMP_DATA_START(Image_5), lcd, 100, 64);
	for (int _counter = 0; _counter < sizeof(lcd); ++_counter) {
		lcd[_counter] |= lcd_copy[_counter];
	}
	display_bitmap_copy(lcd, 100, 8, 0, 0);
...
TASK(TASK_MAIN)
{
	...
	label_a5eb58fe09c443a4b34046036b198665:
	x = ecrobot_get_nxtcolorsensor_id(NXT_PORT_S1);
	goto label_d63a6972cc544ff4941d0460354709b2;
	label_d63a6972cc544ff4941d0460354709b2:
	ActivateTask(TASK_cbc7ff945c887eb060734efd34e);
	label_dbadeaa0947b9b7f17fee35fee7d9:
	if (x > 0) {
